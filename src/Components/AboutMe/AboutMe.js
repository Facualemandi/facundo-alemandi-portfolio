      ...
      <Main valor={theme}>
        <SectionOne>
          ...
          <Parraagraph valor={theme}>
            ...
            especializo en <Bold valor={theme}>Desarrollo Frontend</Bold>. Estudié
            programación de manera autodidacta, comencé con los conceptos básicos <Bold valor={theme}>HTML</Bold>,
